...
Question question[QTYQ]{
	...
	{"Я дед инсайд ... я хочу в психо кидс", {"мне 8 лет", "мне 9 лет", "мне 10 лет", "мне 11 лет"},"мне 10 лет" , "мне 9 лет"},
...
{
	system("cls");
	cout << "Правила викторины: \n[!]   В настройках вы выбираете предпочтительные настройки для прохождения викторины. \nДалее ваша задача - правильно отвечать на вопрсы.\nУ вас есть огранниченное количество жизней(прав на ошибку), если вы ошибетесь максимальное колличество раз,\nвы проиграете и викторина завершиться.\n";
}
